...
angular.module("template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/modal/window.html",
    ...
    "    </div>\n" +
    "  </div>\n" +
    "</div>");/*Modified By LanXiu At 2014-11-1，增加modal-outside,modal-inside类的div标签，使得弹窗垂直居中；Modified By LanXiu At 2014-11-10，增加modal-lger类，针对点菜弹窗的宽度设置*/
}]);
...
angular.module("template/pagination/pagination.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/pagination/pagination.html",
    ...
    "</p>\n" +
    "</div>"+
    "</div>");/*Modified By LanXiu At 2014-10-27，新增div的html元素，实现totalItems为0时不显示分页，以及实现第几页的页面跳转；Modified By LanXiu At 2014-11-19，针对弹窗内totalItems不为0时报错并不显示分页，更改ng-if的位置以避免该问题的出现*/
}]);
