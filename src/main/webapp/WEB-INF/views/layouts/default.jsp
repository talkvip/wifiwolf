...
<script src="${ctx}/resources/js/jquery-1.11.1.min.js"
	type="text/javascript"></script>
<script src="${ctx}/resources/js/bootstrap-datetimepicker.js"
	type="text/javascript"></script>
<script src="${ctx}/resources/js/bootstrap-datetimepicker.zh-CN.js"
	type="text/javascript"></script>
...
<link href="${ctx}/resources/css/custom.css" type="text/css"
	rel="stylesheet" />
